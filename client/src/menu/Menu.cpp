...
void Menu::initMainMenu(sf::RenderWindow& window, GameEngine::System system) {
    if (_currentMenuState == MenuState::MainMenu) {
        if (!_entitiesInitialized) {
            ...
            _entitiesMenu.emplace(entityId, createEntityRect(entityId++, {responsive.getResponsiveSizeX(1920, currentWidth, 150), responsive.getResponsiveSizeY(1080, currentHeight, 50)}, {{responsive.getResponsivePosX(1920, currentWidth, 1300), responsive.getResponsivePosY(1080, currentHeight, 80)}}, sf::Color::Red, [this]() {isClickedInput(false, false, true);})); //username inputRect
            _entitiesMenu.emplace(entityId, createEntityInput(entityId++, "assets/font/Inter_Bold.ttf", 40, {{responsive.getResponsivePosX(1920, currentWidth, 1050), responsive.getResponsivePosY(1080, currentHeight, 78)}}, "Username"));
            _entitiesMenu.emplace(entityId, createEntityInput(entityId++, "assets/font/Inter_Bold.ttf", 40, {{responsive.getResponsivePosX(1920, currentWidth, 1305), responsive.getResponsivePosY(1080, currentHeight, 78)}}, "")); //username input text
            _usernameId = entityId;
            _entitiesMenu.emplace(entityId, createEntityRect(entityId++, {responsive.getResponsiveSizeX(1920, currentWidth, 150), responsive.getResponsiveSizeY(1080, currentHeight, 50)}, {{responsive.getResponsivePosX(1920, currentWidth, 1300), responsive.getResponsivePosY(1080, currentHeight, 150)}}, sf::Color::Red, [this]() {isClickedInput(true, false, false);})); //ip inputRect
            _entitiesMenu.emplace(entityId, createEntityInput(entityId++, "assets/font/Inter_Bold.ttf", 40, {{responsive.getResponsivePosX(1920, currentWidth, 1050), responsive.getResponsivePosY(1080, currentHeight, 148)}}, "IP"));
            _entitiesMenu.emplace(entityId, createEntityInput(entityId++, "assets/font/Inter_Bold.ttf", 40, {{responsive.getResponsivePosX(1920, currentWidth, 1305), responsive.getResponsivePosY(1080, currentHeight, 148)}}, "")); //ip input text
            _ipId = entityId;
            _entitiesMenu.emplace(entityId, createEntityRect(entityId++, {responsive.getResponsiveSizeX(1920, currentWidth, 150), responsive.getResponsiveSizeY(1080, currentHeight, 50)}, {{responsive.getResponsivePosX(1920, currentWidth, 1300), responsive.getResponsivePosY(1080, currentHeight, 220)}}, sf::Color::Red, [this]() {isClickedInput(false, true, false);})); //port inputRect
            _entitiesMenu.emplace(entityId, createEntityInput(entityId++, "assets/font/Inter_Bold.ttf", 40, {{responsive.getResponsivePosX(1920, currentWidth, 1050), responsive.getResponsivePosY(1080, currentHeight, 218)}}, "Port"));
            _entitiesMenu.emplace(entityId, createEntityInput(entityId++, "assets/font/Inter_Bold.ttf", 40, {{responsive.getResponsivePosX(1920, currentWidth, 1305), responsive.getResponsivePosY(1080, currentHeight, 218)}}, "")); //port input tex
            _portId = entityId;
