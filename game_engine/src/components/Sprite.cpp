...
** It holds a `texturePath` as a string and `size` as a vector of two doubles representing the width and height.
** The constructor allows initializing these attributes with default values.
*/

#include "components/Sprite.hpp"

Sprite::Sprite(std::string texturePath, std::vector<double> size) : _texturePath(texturePath), _size(size)
{
}
