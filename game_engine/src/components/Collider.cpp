...
** Collider.cpp
**
** The Collider class represents the collider component for an entity in the game.
** It holds the size of the collider as a vector of doubles. The constructor allows initializing
